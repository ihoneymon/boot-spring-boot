...
| 구분 | 링크 |
|------|------|
| Release Notes | [Spring Boot 2.6 Release Notes](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.6-Release-Notes) |
| Reference Docs | [Spring Boot 2.6.14 Reference](https://docs.spring.io/spring-boot/docs/2.6.14/reference/html/) |
| API Docs | [Spring Boot 2.6.14 API](https://docs.spring.io/spring-boot/docs/2.6.14/api/) |
| Migration Guide | [Spring Boot 2.6 Migration Guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.6-Release-Notes#deprecations-in-spring-boot-26) |
