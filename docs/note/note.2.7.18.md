...
| 구분 | 링크 |
|------|------|
| Release Notes | [Spring Boot 2.7 Release Notes](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.7-Release-Notes) |
| Reference Docs | [Spring Boot 2.7.18 Reference](https://docs.spring.io/spring-boot/docs/2.7.18/reference/html/) |
| API Docs | [Spring Boot 2.7.18 API](https://docs.spring.io/spring-boot/docs/2.7.18/api/) |
| Migration Guide | [Spring Boot 2.7 Migration Guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.7-Release-Notes#deprecations-in-spring-boot-27) |
| 3.0 Migration 준비 | [Spring Boot 3.0 Migration Guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-3.0-Migration-Guide) |
...
| Spring Security | [Spring Security 5.7 Release Notes](https://docs.spring.io/spring-security/reference/5.7/whats-new.html) |
